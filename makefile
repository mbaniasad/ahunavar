...
all: BIN_DIR  voter_client tumbler_server signer_server candidate_server
...
CLIENT_TARGETS = voter_client alice_client_test
...
SERVER_TARGETS = tumbler_server signer_server candidate_server
